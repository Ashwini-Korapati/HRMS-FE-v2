    ...
    <label className="flex flex-col gap-1.5 group">
      ...
      <div className="relative">
        ...
        <input
          ...
          className={`w-full bg-white dark:bg-neutral-900 border rounded-xl ${
            Icon ? "pl-10" : "pl-3"
          } pr-3 py-2.5 text-sm text-neutral-900 dark:text-neutral-100 placeholder-neutral-400 outline-none transition-all duration-300 ${
            error
              ? "border-rose-400 shadow-rose-100 dark:shadow-rose-900/20 shadow-lg"
              : isFocused
              ? "border-orange-500 shadow-lg shadow-orange-100 dark:shadow-orange-900/20 ring-4 ring-orange-500/10"
              : "border-neutral-200 dark:border-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-600"
          } ${className}`}
        />
      </div>
      {error && (
        <span className="text-xs text-rose-500 animate-in slide-in-from-top-1 duration-300">
          {error}
        </span>
      )}
    </label>
  ...
  return (
    <label className="flex flex-col gap-1.5 group">
      ...
      <textarea
        ...
        onFocus={() => setIsFocused(true)}
        onBlur={() => setIsFocused(false)}
        className={`w-full bg-white dark:bg-neutral-900 border rounded-xl px-3 py-2.5 text-sm text-neutral-900 dark:text-neutral-100 placeholder-neutral-400 outline-none resize-none transition-all duration-300 ${
          error
            ? "border-rose-400 shadow-rose-100 dark:shadow-rose-900/20 shadow-lg"
            : isFocused
            ? "border-orange-500 shadow-lg shadow-orange-100 dark:shadow-orange-900/20 ring-4 ring-orange-500/10"
  ...
  return (
    <label className="flex flex-col gap-1.5 group">
      ...
      <div className="relative">
        {Icon && (
          <Icon
            className={`absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 transition-all duration-300 pointer-events-none z-10 ${
              isFocused ? "text-orange-500" : "text-neutral-400"
            }`}
          />
        )}
        <select
          ...
          className={`w-full bg-white dark:bg-neutral-900 border rounded-xl ${
            Icon ? "pl-10" : "pl-3"
          } pr-10 py-2.5 text-sm text-neutral-900 dark:text-neutral-100 appearance-none outline-none transition-all duration-300 ${
            error
              ? "border-rose-400 shadow-rose-100 dark:shadow-rose-900/20 shadow-lg"
              : isFocused
              ? "border-orange-500 shadow-lg shadow-orange-100 dark:shadow-orange-900/20 ring-4 ring-orange-500/10"
        ...
        <ChevronDown
          className={`absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 pointer-events-none transition-all duration-300 ${
            isFocused ? "text-orange-500 rotate-180" : "text-neutral-400"
          }`}
        />
      </div>
      {error && (
...
const CreateDesignationPage = () => {
  ...
  useEffect(() => {
    if (creating === "succeeded") {
      const message = `Designation "${
        lastCreated?.title || formData.title
  ...
  const handleSubmit = (e) => {
    ...
    const submitData = {
      ...
      enabledRoutes:
        Object.entries(formData.enabledRoutes)
  ...
  const levelLabel = (v) =>
    LEVEL_OPTIONS.find((o) => o.value === v)?.label || "N/A";
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-1.5">
                    ...
                    <span className="text-xs font-bold text-orange-600 dark:text-orange-400">
                      {totalRoutesCount > 0
                        ? Math.round(
                            (activeRoutesCount / totalRoutesCount) * 100
                          )
                        : 0}
                      %
                    </span>
                ...
                <div className="p-6 space-y-4">
                                ...
                                >
                                    ...
                                    <div className="flex items-center gap-2">
                                      <div
                                        className={`w-2 h-2 rounded-full transition-all duration-300 ${
                                          isActive
                                            ? "bg-emerald-500 shadow-lg shadow-emerald-500/50 scale-100"
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap">
                                    <span
                                      className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full text-xs font-semibold transition-all duration-300 ${
                                        isActive
                                          ? "bg-orange-100 dark:bg-orange-950 text-orange-700 dark:text-orange-300 shadow-sm"
                                  ...
                                  <td className="px-6 py-4 whitespace-nowrap">
                                    <button
                                      ...
                                      className={`group/btn relative inline-flex items-center justify-center p-2.5 rounded-xl transition-all duration-300 ${
                                        isActive
                                          ? "bg-orange-50 dark:bg-orange-950 hover:bg-orange-100 dark:hover:bg-orange-900 text-orange-600 dark:text-orange-400 hover:shadow-lg hover:shadow-orange-500/20"
                                          : "bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 text-neutral-500 dark:text-neutral-400 hover:text-neutral-700 dark:hover:text-neutral-300"
                  ...
                  <div className="flex items-center gap-3 pt-2">
                    <button
                      ...
                      className={`group relative inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm font-semibold transition-all duration-300 overflow-hidden ${
                        isFormValid
                          ? "bg-orange-600 text-white shadow-lg shadow-orange-500/30 hover:bg-orange-500 hover:shadow-xl hover:shadow-orange-500/40 hover:-translate-y-0.5"
                    ...
                    >
                      ...
                      <Plus
                        className={`w-4 h-4 relative z-10 transition-transform duration-300 ${
                          isFormValid ? "group-hover:rotate-90" : ""
                        }`}
                      />
                    ...
                    {error && (
                      <div className="animate-in slide-in-from-right-4 duration-300 inline-flex items-center gap-2 bg-rose-50 dark:bg-rose-950 text-rose-700 dark:text-rose-300 px-4 py-2.5 rounded-xl border border-rose-200 dark:border-rose-900 shadow-sm">
                        ...
                        <button
                          ...
                          type="button"
                          className="ml-1 p-1 rounded-lg hover:bg-rose-100 dark:hover:bg-rose-900 transition-colors"
                        >
                          <X className="w-4 h-4" />
                        </button>
                      </div>
            ...
            <div className="sticky top-6 bg-white dark:bg-neutral-900 border border-orange-500/20 dark:border-orange-500/40 rounded-2xl shadow-xl overflow-hidden">
              ...
              <div className="p-6 space-y-4">
                <div className="space-y-3">
                  <div className="group">
                    <div className="text-xs font-semibold text-neutral-500 dark:text-neutral-400 mb-1 uppercase tracking-wider">
                      Title
                    </div>
                ...
                <div className="pt-4 border-t border-neutral-200 dark:border-neutral-800">
                  ...
                  <ul className="space-y-2">
                    {Object.entries(formData.enabledRoutes).map(([k, v]) => (
                      <li
                        key={k}
                        className="group flex items-center justify-between gap-2 text-sm bg-neutral-50 dark:bg-neutral-800 px-3 py-2.5 rounded-lg transition-all duration-300 hover:bg-neutral-100 dark:hover:bg-neutral-700 hover:shadow-md hover:-translate-y-0.5"
                      >
                        <div className="flex items-center gap-2">
                          {v === "Active" ? (
