...
// 		const items = useMemo(() => {
// 			// Format known notification types into human-friendly entries
// 			return notifications.map(n => {
// 				const base = {
// 					id: n.id,
// 					type: n.type || 'INFO',
// 					isRead: !!n.isRead,
// 					// accept multiple timestamp shapes
// 					createdAt: n.at || n.createdAt || n.timestamp || n.time,
// 					metadata: n.metadata || {
// 						userId: n.userId,
// 						leaveId: n.leaveId,
// 						companyId: n.companyId,
...
// 				return
// 			}
// 			// Project member added: go to the project if present
// 			if (kind === 'project.member_added') {
// 				setOpen(false)
// 				const cId = authState?.company?.id
// 				const projectId = n.metadata?.projectId || n.projectId
// 				if (cId && projectId) {
// 					// Best-effort target; adjust if your routes differ
// 					navigate(`/${cId}/projects/${projectId}`)
// 				} else if (cId) {
// 					navigate(`/${cId}/projects`)
// 				} else {
// 					navigate('/projects')
// 				}
// 				return
