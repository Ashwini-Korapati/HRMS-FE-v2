...
const cardClass = "rounded-2xl border border-orange-500/30 bg-white dark:bg-neutral-900 p-4 flex flex-col gap-2 hover:border-orange-500/60 transition-colors shadow-sm"
